...
echo ""
echo "        7. 系統檔案檢核Base檔更新"
echo ""
echo "        8. 系統資源、設定值檢核(seadm's hardware_chk)"
echo ""
echo "        9. 系統檢核Base更新"
echo ""
...
case $Menu_No in
	   ...
	   7)
 	    echo "			開始進行檔案檢核Base檔更新..."
		sleep 1
		echo "			執行指令：$SECCMD base"
							      $SECCMD base
 	    echo "			指令完成(請確檔案檢核Base檔更新結果.)"
		echo ""
		read ANSWR?"               按Enter鍵繼續 "
		STARTT1
	   	;;
...
echo ""
echo ""
echo "        1. 系統檢核(syschk_diff.sh) "
echo ""
echo "        2. 系統檢核Base檔更新(syschk base update)"
echo ""
echo "      (隨時可輸 q 以離開 )"
echo ""
read Menu_No?" 請選擇選項 ($FNUM-$LNUM) : "
...
echo ""
echo "        4. 系統檢核Base檔更新結果"
echo ""
echo "        5. 系統檢核結果(syschk)"
echo ""
...
case $Menu_No in
	   ...
	   1)
 	    echo "			開始進行$WKLPAR與校時主機($NTPSRV)校時結果..."
		sleep 1
		echo "			執行指令：$SECCMD 1"
							      $SECCMD 1 
 	    echo "			指令完成(請確認結果.)"
